...
(function(window){
    const _init = ({
        ...
        ReactDOM.render( <App initObj = {initObj} />, document.getElementById(selector) );
    }

    window.VTBudgetPlanner = {
        init: _init,
    }
})(window);
...
ReactDOM.render(<App initObj={initObj} />, document.getElementById('root')); */
